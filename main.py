...
import string
Root = Tk()
bg1 = PhotoImage(file=r'cust&admin.png')
bg1.subsample(1, 1)
bg2 = PhotoImage(file=r'logout.png')
bg2.subsample(1, 1)
bg3 = PhotoImage(file=r'btn.png')
bg3.subsample(1, 1)
bg4 = PhotoImage(file=r'receipt.png')
bg4.subsample(1, 1)
labelA = Label(Root, image=bg1)
...
def admin_login():
    ...
    bg1 = PhotoImage(file=r'login.png')
    bg1.subsample(1, 1)
    label1 = Label(root1, image=bg1)
    ...
    "------------------------ LABEL ------------------------"
    label2 = Label(root1, text="USERNAME", font='Georgia 15 bold', bg='black', fg='white')
    label2.grid(row=0, column=0, pady=20, padx=10)
    label3 = Label(root1, text="PASSWORD", font='Georgia 15 bold', bg='black', fg='white')
    label3.grid(row=2, column=0, pady=20, padx=10)
    "------------------------ TEXT BOX ------------------------"

    admin_Username = Entry(root1, font='Georgia 20 bold', bg='black', fg='white')
    admin_Username.grid(row=0, column=2, pady=20, padx=10)

    admin_Password = Entry(root1, font='Georgia 20 bold', bg='black', fg='white')
    admin_Password.grid(row=2, column=2, pady=20, padx=10)

    "------------------------ BUTTON ------------------------"
    btn1 = Button(root1, text='LOGIN', font='Georgia 15 italic', fg='white', bg='black', command=For_page3)
    btn1.grid(row=3, column=2, padx=2, pady=15)
...
def admin_panel1():
    ...
    bg1 = PhotoImage(file=r'admin_panel.png')
    bg1.subsample(1, 1)
    labelA = Label(root2, image=bg1)
    labelA.place(x=0, y=0)
    ...
    def C_details():
        ...
        global con, cur, i, bg1
        bg1 = PhotoImage(file=r'Emp_view.png')
        bg1.subsample(1, 1)
        label2 = Label(root20, image=bg1)
        ...
        Label(root20, text="LICENSE", fg='cyan', bg='black', font='Georgia 12 italic').grid(row=1, column=3, pady=10)
        ...
        Label(root20, text="ADDRESS", fg='cyan', bg='black', font='Georgia 12 italic').grid(row=1, column=6, pady=10)
        ...
        for customer in cur:
            for j in range(len(customer)):
                e = Entry(root20, width=12, fg='blue', bg='black', font='Georgia 12 italic')
    ...
    "------------------------ BUTTON ------------------------"
    button1 = Button(root2, text="E M P L O Y E E   D E T A I L S", font='Georgia 15 italic', fg='white', bg='black',
                     borderwidth=3, relief="flat", command=c_details)
    button1.grid(row=4, column=0, pady=600, padx=50)
    button2 = Button(root2, text="C U S T O M E R   D E T A I L S", font='Georgia 15 italic', fg='white', bg='black',
                     borderwidth=3, relief="flat", command=C_details)
    button2.grid(row=4, column=1, pady=10, padx=90)
    button3 = Button(root2, text="C A R   D E T A I L S", command=E_details,
                     font='Georgia 15 italic', fg='white', bg='black', borderwidth=3, relief="flat")
    button3.grid(row=4, column=2, pady=10, padx=80)

    button4 = Button(root2, text='LOGOUT', font='Georgia 15 italic', image=bg3, fg='white', bg='black',
                     command=back_panel1, borderwidth=3, relief="flat")
    button4.grid(row=0, column=3, padx=30, pady=10)
...
def admin_panel4():
    ...
    bg1 = PhotoImage(file=r'car_panel.png')
    bg1.subsample(1, 1)
    bg2 = PhotoImage(file=r'logout.png')
    bg2.subsample(1, 1)
    label1 = Label(root3, image=bg1)
    label1.place(x=0, y=0)
    ...
    def add_car():
        ...
        bg1 = PhotoImage(file=r'add_Car.png')
        bg1.subsample(1, 1)
        label2 = Label(root11, image=bg1)
        label2.place(x=0, y=0)
        ...
        def add():
            ...
            if brand.get() == "" or seat.get() == "" or price.get() == "" or model.get() == "" or fuel.get() == "":
                ...
                try:
                    con = mysql.connector.connect(host="localhost", user="root", password="1234", database="car")
                    cur = con.cursor()
                    query = "insert into add_car(brand, seat, price, model, fuel) values(%s, %s, %s, %s, %s)"
                    Brand = brand.get()
                    Seat = seat.get()
                    Price = price.get()
                    Model = model.get()
    ...
    def del_car():
        ...
        bg1 = PhotoImage(file=r'del_Car.png')
        bg1.subsample(1, 1)
        label2 = Label(root12, image=bg1)
        label2.place(x=0, y=0)
        ...
        def delete():
            ...
            if car_name == "":
                ...
                try:
                    con = mysql.connector.connect(host="localhost", user="root", password="1234", database="car")
                    cur = con.cursor()
                    sql_Delete_query = "Delete from add_car where brand = %s"
        ...
        button = Button(root12, text='BACK', fg='green', bg='black', font='georgia 12 italic', command=back, image=bg3)
    ...
    def view_car():
        ...
        con = mysql.connector.connect(host="localhost", user="root", password="1234", database="car")
        cur = con.cursor()
        cur.execute("SELECT brand, seat, price, model, fuel FROM add_car")
        i = 2
        for car in cur:
        ...
        def back():
            admin_panel4()
            root21.destroy()
        button = Button(root21, text='BACK', fg='green', bg='black', font='georgia 12 italic', command=back, image=bg3)
        button.grid(row=0, column=0, padx=10, pady=10)
...
def admin_panel2():
    ...
    bg1 = PhotoImage(file=r'emp_panel.png')
    bg1.subsample(1, 1)
    label1 = Label(root7, image=bg1)
    label1.place(x=0, y=0)
    ...
    def hire():
        ...
        bg1 = PhotoImage(file=r'hire.png')
        bg1.subsample(1, 1)
        label2 = Label(root8, image=bg1)
        label2.place(x=0, y=0)
        root7.destroy()
        ...
        def Hire():
            ...
            if name.get() == "" or age.get() == "" or gender.get() == "" or Addre.get() == "" \
                ...
                try:
                    con = mysql.connector.connect(host="localhost", user="root", password="1234", database="car")
                    cur = con.cursor()
                    query = "insert into employee(name, age, gender, address, qual, exp, mob) " \
        ...
        button5 = Button(root8, text='S U B M I T', command=Hire, font='Georgia 15 italic', fg='white', bg='black',
                         borderwidth=3, relief="flat")
    ...
    def fire():
        ...
        root9.title('F I R E')
        bg1 = PhotoImage(file=r'fire.png')
        bg1.subsample(1, 1)
        label2 = Label(root9, image=bg1)
        label2.place(x=0, y=0)
        ...
        def Fire():
            ...
            if Id.get() == "":
                ...
                try:
                    con = mysql.connector.connect(host="localhost", user="root", password="1234", database="car")
                    cur = con.cursor()
                    sql_Delete_query = "Delete from employee where name = %s"
                    ...
                    if con.is_connected():
                        cur.close()
                        con.close()
        button5 = Button(root9, command=Fire, font='Georgia 15 italic', fg='white', bg='black',
    ...
    def view_detail():
        ...
        Label(root10, text="ADDRESS", fg='yellow', bg='black', font='Georgia 12 italic').grid(row=1, column=3, pady=10)
        ...
        Label(root10, text="MOBILE", fg='yellow', bg='black', font='Georgia 12 italic').grid(row=1, column=6, pady=10)
        con = mysql.connector.connect(host="localhost", user="root", password="1234", database="car")
        cur = con.cursor()
...
def customer_panel1():
    ...
    bg1 = PhotoImage(file=r'rent&return.png')
    bg1.subsample(1, 1)
    label1 = Label(root13, image=bg1)
    label1.place(x=0, y=0)
    ...
    def rent():
        ...
        bg1 = PhotoImage(file=r'bg.png')
        bg1.subsample(1, 1)
        label2 = Label(root14, image=bg1)
        label2.place(x=0, y=0)
        ...
        def tesla():
            ...
            global images, slide_image, i, show, bg1
            bg1 = PhotoImage(file=r'bg.png')
            bg1.subsample(1, 1)
            label3 = Label(root15, image=bg1)
            ...
            def start1():
                ...
                show = slide_image.after(3000, start1)
        ...
        def start():
            ...
            if i >= (len(images) - 1):
                ...
                i = i + 1
                slide_image.configure(image=images[i])
            show = slide_image.after(3000, start)
    ...
    def Return():
        ...
        bg1 = PhotoImage(file=r'0.png')
        bg1.subsample(1, 1)
        label2 = Label(root19, image=bg1)
        label2.place(x=0, y=0)

        label3 = Label(root19, text='C A R   N A M E', font='Georgia 15 bold', bg='black', fg='white')
        label3.grid(row=1, column=1, pady=20, padx=5)
        ...
        def delete():
            ...
            if car_name == "":
                ...
                try:
                    con = mysql.connector.connect(host="localhost", user="root", password="1234", database="car")
                    cur = con.cursor()
                    sql_Delete_query = "Delete from customer where car = %s"
                    cur.execute(sql_Delete_query, (car_name,))
                    con.commit()
                    messagebox.showinfo("Success", "Successfully deleted")
                    cur.close()
        ...
        button = Button(root19, text='BACK', fg='green', bg='black', font='georgia 12 italic', command=back, image=bg3)
        button.grid(row=0, column=0, padx=5, pady=5)
    "------------------------ BUTTON ------------------------"
    button1 = Button(root13, text='R E N T   C A R', font='Georgia 15 italic', fg='white', bg='black',
                     borderwidth=3, relief="flat", command=rent)
    button1.grid(row=1, column=1, padx=200, pady=500)
    button2 = Button(root13, text='R E T U R N   C A R ', font='Georgia 15 italic', fg='white', bg='black',
                     borderwidth=3, relief="flat", command=Return)
    button2.grid(row=1, column=2, padx=500)


def Customer_detail():
    global bg1, issued_date, end_date, address, Phone
    root18 = Toplevel(Root)
    root18.attributes('-fullscreen', True)
    root18.configure(background='black')
    bg1 = PhotoImage(file='cust_detail.png')
    bg1.subsample(1, 1)
    label1 = Label(root18, image=bg1)
    label1.place(x=0, y=0)
    ...
    def add():
        ...
        if name.get() == "" or age.get() == "" or gender.get() == "" or lic.get() == "" or issued.get() == "" \
            ...
            try:
                con = mysql.connector.connect(host="localhost", user="root", password="1234", database="car")
                cur = con.cursor()
                query = "insert into customer(name, age, gender, license, issued, end, address, " \
...
def payment():
    global bg1, n, company, a, name_card
    root22 = Toplevel(Root)
    root22.attributes('-fullscreen', True)
    root22.configure(background='black')
    bg1 = PhotoImage(file='payment.png')
    bg1.subsample(1, 1)
    label1 = Label(root22, image=bg1)
    label1.place(x=0, y=0)
    ...
    def process():
        ...
        if m.get() == "" or name_card.get() == "" or cvv.get() == "" or card.get() == "" or n.get() == ""\
            ...
            try:
                con = mysql.connector.connect(host="localhost", user="root", password="1234", database="car")
                cur = con.cursor()
                query = "insert into bal_history(type, name, amount) values(%s, %s, %s)"
                Name = name_card.get()
                Amount = a.get()
                Type = n.get()
                record = (Type, Name, Amount)
                cur.execute(query, record)
                con.commit()
                bar()
                messagebox.showinfo("Success", "Payed Successfully", parent=Root)
                receipt()
            except Exception as es:
...
def receipt():
    ...
    r_no = Label(root23, text='RECEIPT   NUMBER', font='georgia 15 italic', fg='white', bg='black', relief="groove")
    r_no.grid(row=4, column=0, padx=10, pady=20)

    R_no = Label(root23, text=f"{r}", font='georgia 15 italic', fg='black', bg='white')
    R_no.grid(row=4, column=1)
    ...
    Button(root23, text="E X I T", font='georgia 15 italic', fg='black', bg='white', command=Root.destroy)\
        .grid(row=9, column=2, pady=30)


"----------------------------------------------- LABEL -----------------------------------------------"
labelB = Label(Root, text='W E L C O M E   T O    W A N D E R    W H E E L S',
               font='Georgia 15 italic', fg='white', bg='black')
labelB.grid(rowspan=1, column=1, padx=300,  pady=20)
...
btnA.grid(row=3, columnspan=1, padx=15, pady=500)
